...
public final class ActivityLoginBinding implements ViewBinding {
  ...
  private ActivityLoginBinding(@NonNull ConstraintLayout rootView, @NonNull Button LoginBtn,
      @NonNull Button RegBtn, @NonNull EditText editTextTextEmailAddress,
      @NonNull EditText editTextTextPassword, @NonNull ImageView imageView2,
      @NonNull ImageView imageView3, @NonNull ConstraintLayout main, @NonNull TextView textView2,
  ...
  public static ActivityLoginBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ActivityLoginBinding((ConstraintLayout) rootView, LoginBtn, RegBtn,
          editTextTextEmailAddress, editTextTextPassword, imageView2, imageView3, main, textView2,
          textView5, textView6);
    }
