...
class ProfileActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        major = findViewById(R.id.Rating)
        year = findViewById(R.id.Speciality)
    ...
    private fun loadUserProfile() {
        ...
        val userMajor = sharedPreferences.getString("user_major", "N/A")
        val userYear = sharedPreferences.getString("user_year", "N/A")
        ...
        major.text = userMajor ?: "N/A"
        year.text = userYear ?: "N/A"
